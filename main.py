...
story_data = {"story_so_far": "", "theme": "", "genre": "", "setting": ""}

def generate_story(theme, genre, setting, story_so_far="", user_input=None, end_story=False):
    ...
    Keep it engaging, creative, and logically connected.
...
def continue_story():
    ...
    story_part = generate_story(
        ...
        story_data["story_so_far"], user_input
    )
...
def end_story():
    story_ending = generate_story(
        story_data["theme"], story_data["genre"], story_data["setting"],
        story_data["story_so_far"], end_story=True
    )
